...
## [0.95.0](https://github.com/reanahub/reana-ui/compare/0.9.4...0.95.0) (2026-09-22)


### ⚠ BREAKING CHANGES

* **auth:** Deploy this UI with the OIDC-compatible REANA server and enable its browser login flow. Local email/password sign-in, registration, email confirmation and legacy token requests are removed. Sign in again through the configured identity provider after upgrading, and use the matching OIDC client with reana-client login instead of copying a token from the profile. Renew delegated GitLab webhook authorisation when it expires so GitLab can keep starting workflows.
...
* **deps:** bump axios, dompurify, sass and more ([#509](https://github.com/reanahub/reana-ui/issues/509)) ([31ac9e8](https://github.com/reanahub/reana-ui/commit/31ac9e8d7d14b9fd09e3de8a9513b6b1251d396b))
* **deps:** bump axios, webpack, postcss and more ([#482](https://github.com/reanahub/reana-ui/issues/482)) ([19a3628](https://github.com/reanahub/reana-ui/commit/19a36288708089f567286e1a7cb09bfcb5ef8dc4))
...
* **deps:** bump babel, less, dompurify and more ([#490](https://github.com/reanahub/reana-ui/issues/490)) ([c60dbda](https://github.com/reanahub/reana-ui/commit/c60dbda10abc3bf1ac62d14e621cd1755fa89e01))
...
* **auth:** adopt OIDC sessions and webhook renewal ([#517](https://github.com/reanahub/reana-ui/issues/517)) ([5b2647a](https://github.com/reanahub/reana-ui/commit/5b2647ab23b105f08cc1f2281440b94b624f16df))
* **dask:** hide service logs tab if dask not supported ([#466](https://github.com/reanahub/reana-ui/issues/466)) ([50f2fa9](https://github.com/reanahub/reana-ui/commit/50f2fa95febacb1ae4cdc143638078c1d73cb040)), closes [#462](https://github.com/reanahub/reana-ui/issues/462)
...
* **profile:** show CPU quota period window ([#494](https://github.com/reanahub/reana-ui/issues/494)) ([90df5f0](https://github.com/reanahub/reana-ui/commit/90df5f04854bd04ef76e45058c4f55f4beb2cd22))
...
* **signin:** skip confirm email notice under auto token policy ([#474](https://github.com/reanahub/reana-ui/issues/474)) ([67afd16](https://github.com/reanahub/reana-ui/commit/67afd16aa6bdbd08724c59c70a1e8f8c05a0f39f))
* **status:** add footnote explaining available number of jobs ([#467](https://github.com/reanahub/reana-ui/issues/467)) ([00a7eae](https://github.com/reanahub/reana-ui/commit/00a7eaea443e0e8eda64c5f43291fb3788c90669)), closes [#464](https://github.com/reanahub/reana-ui/issues/464)
...
* **ui:** introduce prune workspace functionality ([#478](https://github.com/reanahub/reana-ui/issues/478)) ([ccf7137](https://github.com/reanahub/reana-ui/commit/ccf71371519f70e28c1a1892e1903ea4f9d010cf)), closes [#476](https://github.com/reanahub/reana-ui/issues/476)
...
* **workflow-delete:** guard deletion of restarted runs ([#469](https://github.com/reanahub/reana-ui/issues/469)) ([90a7e68](https://github.com/reanahub/reana-ui/commit/90a7e68e116acee03ae56f5b3fa742a10f8b1759)), closes [#448](https://github.com/reanahub/reana-ui/issues/448)
...
* **workflow-details:** add shareable links for workspace files ([#506](https://github.com/reanahub/reana-ui/issues/506)) ([036d00f](https://github.com/reanahub/reana-ui/commit/036d00f6296836ab80c5f96ec5d165f262acf6b9))
* **workflow-details:** permanent line anchors for logs ([#511](https://github.com/reanahub/reana-ui/issues/511)) ([1423883](https://github.com/reanahub/reana-ui/commit/1423883032847649ec854884950284d4aeeaa403)), closes [#503](https://github.com/reanahub/reana-ui/issues/503)
...
* **workflow-details:** reorder log tabs ([#499](https://github.com/reanahub/reana-ui/issues/499)) ([55b8d39](https://github.com/reanahub/reana-ui/commit/55b8d39294a6bd347df9534d87e55eaaa74654d5))
...
* **workflow-list:** introduce faceted sidebar filtering ([#514](https://github.com/reanahub/reana-ui/issues/514)) ([eaaec40](https://github.com/reanahub/reana-ui/commit/eaaec40c2952bf23eb3b502829f51d4d84149c93))
...
* **auth:** limit self-logout to session expiry 401 responses ([#492](https://github.com/reanahub/reana-ui/issues/492)) ([0c9ba31](https://github.com/reanahub/reana-ui/commit/0c9ba31fe89f50a5bc9a7e603bcaa1b322033926))
* **auth:** redirect to sign-in page on session expiry ([#491](https://github.com/reanahub/reana-ui/issues/491)) ([da97ef1](https://github.com/reanahub/reana-ui/commit/da97ef10b42eafd2b16a85b0cdd4d585ff695d0c))
* **client:** send sign-in credentials as form data ([#498](https://github.com/reanahub/reana-ui/issues/498)) ([448a015](https://github.com/reanahub/reana-ui/commit/448a01501bc9664518b527e64be4ad0c50e08fa6))
* **dask:** hide empty service log component selector ([#496](https://github.com/reanahub/reana-ui/issues/496)) ([06b1629](https://github.com/reanahub/reana-ui/commit/06b162984fa967265cd3a39f219117af55b79662)), closes [#493](https://github.com/reanahub/reana-ui/issues/493)
* **file-preview:** stop transpiling jsroot ([#531](https://github.com/reanahub/reana-ui/issues/531)) ([c89001c](https://github.com/reanahub/reana-ui/commit/c89001c4e20cc3d7434461c8a6c9fba5ee7b7d9e))
...
* **workflow-details:** stop workspace spinner on fetch errors ([#497](https://github.com/reanahub/reana-ui/issues/497)) ([b257848](https://github.com/reanahub/reana-ui/commit/b2578482647d697d2762fbb22b19fbf1d367d64c))
* **workflow-list:** improve sharing filter URL state handling ([#507](https://github.com/reanahub/reana-ui/issues/507)) ([4dba8f4](https://github.com/reanahub/reana-ui/commit/4dba8f47c99a64c96a6f36b423be974636c2cda8)), closes [#508](https://github.com/reanahub/reana-ui/issues/508)
...
* **jsonlint:** add JSON linting checks ([#485](https://github.com/reanahub/reana-ui/issues/485)) ([2177c12](https://github.com/reanahub/reana-ui/commit/2177c12e45901fd204ef96e71422df004566c72b))
* **markdownlint:** add Markdown linting checks ([#485](https://github.com/reanahub/reana-ui/issues/485)) ([546c789](https://github.com/reanahub/reana-ui/commit/546c78943457b7da3aedce9314ee466271194599))
* **release-please:** upgrade action to v5 ([#521](https://github.com/reanahub/reana-ui/issues/521)) ([c93e12d](https://github.com/reanahub/reana-ui/commit/c93e12d6d90e245a379b112d0bde104541b07b8d))
* **run-tests:** add usage help and refactor options ([#485](https://github.com/reanahub/reana-ui/issues/485)) ([f17a50f](https://github.com/reanahub/reana-ui/commit/f17a50fa9b05f8a2cd98e12830ae28b44774138a))
...
* **shfmt:** add shfmt code formatting checks ([#485](https://github.com/reanahub/reana-ui/issues/485)) ([62d0e6b](https://github.com/reanahub/reana-ui/commit/62d0e6bd160f9ac2f2dad4cc6a5e08f548c26ef2))
* **yamllint:** add YAML linting checks ([#485](https://github.com/reanahub/reana-ui/issues/485)) ([2fa17fb](https://github.com/reanahub/reana-ui/commit/2fa17fba4a2436858cd4feadb1a42b9778bc4879))

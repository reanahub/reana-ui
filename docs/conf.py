...
g = {}
with open(os.path.join("..", "reana-ui", "package.json"), "rt") as fp:
    data = json.load(fp)
...
html_theme_options = {
    "logo": "logo-reana.png",
    "description": """<p>REANA-UI is a component of the <a
                      href="http://www.reana.io">REANA</a> reusable and
                      reproducible research data analysis
                      platform.</p><p>REANA-UI provides a web interface
                      to review production and historical workflows.</p>""",
    "github_user": "reanahub",
    "github_repo": "reana-ui",
    "github_button": False,
    "github_banner": True,
